...
if __name__ == '__main__':
    ...
    # 数据 
    province = ['太平洋','日本','英国','韩国','美利坚合众国','希腊','欧洲','马来西亚','澳大利亚','亚洲','西班牙','老挝','朝鲜民主主义人民共和国','也门','缅甸','法國','阿拉伯联合酋长国','蒙古国','中非共和國','俄罗斯','泰国','印度尼西亚 ','奈及利亞','玻利维亚','塞爾維亞','秘鲁','瑞士','比利時','越南','德国','北部湾']
    province_n = province
    wordnum = [18,299,143,123,354,47,188,72,17,63,21,31,34,18,27,28,12,13,40,19,26,24,12,16,26,14,16,17,28,21,13]
    ...
    plt.text (10,350,'click the bars to get the details number above 10' ,fontsize=10,color = "blue",fontproperties=prop3) 
